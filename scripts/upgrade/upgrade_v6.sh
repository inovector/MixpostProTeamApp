...
echo "Upgrade Mixpost Pro from v5 to v6"
echo ""
...
if [[ "$CURRENT_VERSION" == 6.* ]]; then
    echo "Mixpost Pro is already on v6 ($CURRENT_VERSION). No upgrade needed."
    exit 0
fi
...
# Update dependencies
composer require inovector/mixpost-pro-team:^6.0 -W
...
MIGRATION_SOURCE="vendor/inovector/mixpost-pro-team/database/migrations-upgrade/2026_05_22_123148_upgrade_mixpost_v6.php"
MIGRATION_DEST="database/migrations/2026_05_22_123148_upgrade_mixpost_v6.php"
...
echo ""
echo "Mixpost Pro has been upgraded to v6 successfully!"
